/*! Summernote v0.8.1 | (c) 2013-2015 Alan Hong and other contributors | MIT license */ !(function(
  a
) {
      ...
      (this.initialize = function() {
        var b = f.dialogsInBody ? a(document.body) : e,
          c =
            ...
            g.link.url +
            '</label><input class="note-link-url form-control" type="text" value="https://" /></div>' +
            (f.disableLinkTarget
              ? ""
            ...
            .Deferred(function(a) {
              ...
              d.onDialogShown(c.$dialog, function() {
                b.triggerEvent("dialog.shown"),
                  ...
                  e.url ||
                    ((e.url = e.text || "https://"), d.toggleBtn(h, e.text)),
                  g
                    .on("input", function() {

...
export default new Router({
  routes: [
    ...
    },
    {
      path: "/about",
      name: "About",
      component: () => import("@/views/almost_static/About"),
      meta: {
        title: "About",
        metaTags: [
          {
    ...
    //   path: "/board",
    //   name: "Board",
    //   component: () => import("@/views/almost_static/Board"),
    //   meta: {
    //     title: "Board",
    //     metaTags: [
    //       {
    ...
    //   path: "/events",
    //   name: "Events",
    //   component: () => import("@/views/almost_static/Events"),
    //   meta: {
    //     title: "Events",
    //     metaTags: [
    //       {
    ...
    //   path: "/publications",
    //   name: "Publications",
    //   component: () => import("@/views/almost_static/Publications"),
    //   meta: {
    //     title: "Publications",
    //     metaTags: [
    //       {
    ...
    },
    {
      path: "/contact",
      name: "Contact",
      component: () => import("@/views//almost_static/Contact"),
      meta: {
        title: "Contact",
        metaTags: [
          {
    ...
    //   path: "/privacy",
    //   name: "Privacy",
    //   component: () => import("@/views/almost_static/Privacy"),
    //   meta: {
    //     title: "Privacy",
    //     metaTags: [
    //       {
    ...
    //   path: "/terms",
    //   name: "Terms",
    //   component: () => import("@/views/almost_static/Terms"),
    //   meta: {
    //     title: "Terms",
    //     metaTags: [
    //       {

    ...
    <form @submit.prevent="apply">
      ...
      <header class="page-header">
        <div class="container page-name">
          ...
          <p class="lead text-center">Ngarkoni dhe dergoni mandat pagesen perseri.</p>
        </div>
...
export default {
  ...
  methods: {
    ...
    apply() {
      ...
      let PAYMENT_ID = 1
      let PAYMENT_MEDIA_ID = 1

      axios.put(
          "https://aace.ml/api/user/" + USER_ID + "/payment/" + PAYMENT_ID,
          this.payment_data,
          {
        ...
        .then(res => {
          ...
          axios
            .put(
              "https://aace.ml/api/user/" + USER_ID + "/payment/" + PAYMENT_ID + "/media/" + PAYMENT_MEDIA_ID,
              formDataPayment,
              {
                "Content-Type": "multipart/form-data",
                headers: {
